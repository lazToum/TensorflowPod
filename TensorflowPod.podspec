...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lazToum/TensorflowPod"
  ...
  s.author             = { "Lazaros Toumanidis" => "laztoum@gmail.com" }
  ...
  s.source = { :http => "https://github.com/laztToum/TensorflowPod/releases/download/v#{s.version}/tensorflow.tar.gz" }
